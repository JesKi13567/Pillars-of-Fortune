...
execute if score #ctrl_map jkpof.int matches -1 store result score #ctrl_map_real jkpof.int run random value 1..8
...
execute if score #ctrl_map_real jkpof.int matches 6 run data modify storage jk:pof data.map.block1 set value "decorated_pot"
execute if score #ctrl_map_real jkpof.int matches 6 run data modify storage jk:pof data.map.block2 set value "flower_pot"
