...
scoreboard players set #ctrl_locator_bar jkpof.int 0
scoreboard players set #ctrl_actionbar jkpof.int 0
scoreboard players set #ctrl_bossbar jkpof.int 0
scoreboard players set #ctrl_player_list jkpof.int 0
