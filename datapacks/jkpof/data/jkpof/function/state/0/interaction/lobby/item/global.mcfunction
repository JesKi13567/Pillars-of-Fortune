...
execute if score #lobby_item jkpof.int matches 13 run data modify entity @e[type=text_display, tag=jkpof_display_lobby_item, tag=-1, limit=1] text set value ["", {storage: "jk:pof", nbt: "txt.lobby.item.death_note.name", color: "dark_red"}, "\n", {storage: "jk:pof", nbt: "txt.lobby.item.death_note.lore.p1", color: "aqua"}, "\n", {storage: "jk:pof", nbt: "txt.lobby.item.death_note.lore.p2", color: "aqua"}, "\n", {storage: "jk:pof", nbt: "txt.lobby.item.death_note.lore.p3", color: "aqua"}, {translate: "item.minecraft.apple"}, " : ", {translate: "item.minecraft.golden_apple"}, " : ", {translate: "item.minecraft.enchanted_golden_apple"}, " = 10% : 20% : 50%"]
