...
execute if score #ctrl_item_prop_chance jkpof.int matches 0 run data modify entity @e[type=text_display, tag=jkpof_display_show_ctrl_item_prop_chance, limit=1] text set value [{text: "21/1247", color: "yellow"}]
