...
execute if score #ctrl_advancement jkpof.int matches 1 run data merge entity @e[type=item_display, tag=jkpof_display_ctrl_advancement, limit=1] {CustomName: {text: "开启", color: "yellow"}, item: {id: "dragon_egg"}}
