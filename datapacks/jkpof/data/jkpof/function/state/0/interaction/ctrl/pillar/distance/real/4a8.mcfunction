...
execute if score #ctrl_pillar_count_order_real jkpof.int matches 8 run scoreboard players set #style_temp jkpof.int 0
...
execute if score #ctrl_pillar_count_order_real jkpof.int matches 8 run scoreboard players set #style_temp jkpof.int 1
