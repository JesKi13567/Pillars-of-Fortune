...
execute as @s[tag=jkpof_ctrl_map, tag=15] run tellraw @a ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.mix", color: "gold"}, {storage: "jk:pof", interpret: true, nbt: "txt.char.colon"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.custom.p1"}, {translate: "gameMode.creative", color: "aqua"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.custom.p2"}]
execute as @s[tag=jkpof_ctrl_map, tag=16] run tellraw @a ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.combine", color: "gold"}, {storage: "jk:pof", interpret: true, nbt: "txt.char.colon"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.custom.p1"}, {translate: "gameMode.creative", color: "aqua"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.custom.p2"}]
execute as @s[tag=jkpof_ctrl_map, tag=17] run tellraw @a ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.3f", color: "gold"}, {storage: "jk:pof", interpret: true, nbt: "txt.char.colon"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.custom.p1"}, {translate: "gameMode.creative", color: "aqua"}, {storage: "jk:pof", interpret: true, nbt: "txt.map.global.custom.p2"}]
