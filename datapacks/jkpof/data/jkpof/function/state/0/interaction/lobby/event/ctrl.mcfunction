...
execute if score #event_ctrl jkpof.int matches 0 run scoreboard players set #event_enable_7 jkpof.int 0
...
execute if score #event_ctrl jkpof.int matches 1 run scoreboard players set #event_enable_7 jkpof.int 1
