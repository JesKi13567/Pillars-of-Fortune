...
execute if score #event_order jkpof.int matches -2 run data modify entity @e[type=text_display, tag=jkpof_display_event_order, tag=-3, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.event.vote.name"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.vote.lore", color: "aqua"}]
...
execute if score #event_order jkpof.int matches -1 run data modify entity @e[type=text_display, tag=jkpof_display_event_order, tag=-3, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.event.border.name"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.border.lore.p1", color: "aqua"}, {text: "→← + ↓/↑", color: "green"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.border.lore.p2", color: "aqua"}]
...
execute if score #event_order jkpof.int matches 0 run data modify entity @e[type=text_display, tag=jkpof_display_event_order, tag=-3, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.event.nothing.name"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.nothing.lore", color: "aqua"}]
...
execute if score #event_order jkpof.int matches 1 run data modify entity @e[type=text_display, tag=jkpof_display_event_order, tag=-3, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.event.arrow.name"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.arrow.lore.p1", color: "aqua"}, {translate: "entity.minecraft.arrow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.arrow.lore.p2", color: "aqua"}]
...
execute if score #event_order jkpof.int matches 3 run data modify entity @e[type=text_display, tag=jkpof_display_event_order, tag=-3, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.event.lightning.name"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.lightning.lore.p1", color: "aqua"}, {translate: "entity.minecraft.lightning_bolt"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.lightning.lore.p2", color: "aqua"}, {translate: "item.minecraft.golden_apple"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.lightning.lore.p3", color: "aqua"}, {translate: "item.minecraft.enchanted_golden_apple"}, {storage: "jk:pof", interpret: true, nbt: "txt.char.dot", color: "aqua"}]
...
execute if score #event_order jkpof.int matches 6 run data modify entity @e[type=text_display, tag=jkpof_display_event_order, tag=-3, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.event.chain_swap.name"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.chain_swap.lore", color: "aqua"}]
...
execute if score #event_order jkpof.int matches 7 run data modify entity @e[type=text_display, tag=jkpof_display_event_order, tag=-3, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.event.prop_supply.name"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.prop_supply.tellraw", color: "aqua"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.event.prop_supply.lore", color: "aqua"}, {text: " 16/1262 ", color: "aqua"}, {storage: "jk:pof", interpret: true, nbt: "txt.char.dot", color: "aqua"}]
...
execute if score #event_ctrl jkpof.int matches 1 if score #event_enables jkpof.int matches 10 run data modify entity @e[type=text_display, tag=jkpof_display_event_ctrl, limit=1] text set value {storage: "jk:pof", interpret: true, nbt: "txt.lobby.bool.enabled.all", color: "green"}
