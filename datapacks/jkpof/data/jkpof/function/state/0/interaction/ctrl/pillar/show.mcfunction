...
execute if score #ctrl_team jkpof.int matches 0 run data modify entity @e[type=text_display, tag=jkpof_display_players, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.lobby.play_tip.p1", color: "yellow"}, {text: "2~", color: "gold"}, {score: {name: "#ctrl_pillar_count_num", objective: "jkpof.int"}, color: "gold"}, {storage: "jk:pof", interpret: true, nbt: "txt.lobby.play_tip.p2.players"}]
