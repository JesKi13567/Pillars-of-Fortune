...
data modify entity @e[type=text_display, tag=jkpof_lobby_const_top_lore, limit=1] text set value [{storage: "jk:pof", nbt: "txt.POF", color: "yellow"}, {text: "v1.2.2", color: "gold"}, "\n", {storage: "jk:pof", nbt: "txt.lobby.const.top.lore.p1", color: "green"}, "\n", {storage: "jk:pof", nbt: "txt.lobby.const.top.lore.p2", color: "aqua"}, {text: "JK137", color: "aqua"}, {storage: "jk:pof", nbt: "txt.lobby.const.top.lore.p3", color: "white"}]
