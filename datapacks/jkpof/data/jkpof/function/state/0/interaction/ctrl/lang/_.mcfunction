...
data modify entity @e[type=text_display, tag=jkpof_display_ctrl_others_show, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.lobby.const.settings.others", color: "gold"}]
data modify entity @e[type=text_display, tag=jkpof_display_ctrl_time, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.lobby.const.settings.time", color: "green"}]
data modify entity @e[type=text_display, tag=jkpof_display_ctrl_natural_regen, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.lobby.const.settings.natural_regen", color: "green"}]
data modify entity @e[type=text_display, tag=jkpof_display_ctrl_advancement, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.lobby.const.settings.advancement", color: "green"}]
data modify entity @e[type=text_display, tag=jkpof_display_ctrl_locator_bar, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.lobby.const.settings.locator_bar", color: "green"}]
data modify entity @e[type=text_display, tag=jkpof_display_ctrl_upside_down, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.lobby.const.settings.upside_down", color: "green"}]
data modify entity @e[type=text_display, tag=jkpof_display_ctrl_kid_mode, limit=1] text set value [{storage: "jk:pof", interpret: true, nbt: "txt.lobby.const.settings.kid_mode", color: "green"}]
