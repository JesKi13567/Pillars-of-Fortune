...
$execute if items entity @e[type=item_display, tag=jkpof_display_ctrl_map, tag=$(x), limit=1] container.0 carrot run data modify storage jk:pof data.map.$(x) set value "carrots[age=7]"
$execute if items entity @e[type=item_display, tag=jkpof_display_ctrl_map, tag=$(x), limit=1] container.0 potato run data modify storage jk:pof data.map.$(x) set value "potatoes[age=7]"
$execute if items entity @e[type=item_display, tag=jkpof_display_ctrl_map, tag=$(x), limit=1] container.0 wheat_seeds run data modify storage jk:pof data.map.$(x) set value "wheat[age=7]"
$execute if items entity @e[type=item_display, tag=jkpof_display_ctrl_map, tag=$(x), limit=1] container.0 beetroot_seeds run data modify storage jk:pof data.map.$(x) set value "beetroots[age=3]"
$execute if items entity @e[type=item_display, tag=jkpof_display_ctrl_map, tag=$(x), limit=1] container.0 pumpkin_seeds run data modify storage jk:pof data.map.$(x) set value "pumpkin_stem[age=7]"
$execute if items entity @e[type=item_display, tag=jkpof_display_ctrl_map, tag=$(x), limit=1] container.0 melon_seeds run data modify storage jk:pof data.map.$(x) set value "melon_stem[age=7]"
$execute if items entity @e[type=item_display, tag=jkpof_display_ctrl_map, tag=$(x), limit=1] container.0 farmland run data modify storage jk:pof data.map.$(x) set value "farmland[moisture=7]"
