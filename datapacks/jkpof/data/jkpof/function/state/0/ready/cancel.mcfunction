...
execute if score #ctrl_team jkpof.int matches 0 run tellraw @a [{storage: "jk:pof", nbt: "txt.POF", color: "yellow"}, {storage: "jk:pof", nbt: "txt.game.cancel.lack.players", color: "red"}]
