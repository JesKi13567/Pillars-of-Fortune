...
execute if score #is_prop jkpof.int matches 1 unless score #ctrl_lang jkpof.int matches 2 as @a[scores={jkpof.state=2, jkpof.item.order=1}] run loot give @s loot jkpof:item/prop/death_note/zh
execute if score #is_prop jkpof.int matches 1 if score #ctrl_lang jkpof.int matches 2 as @a[scores={jkpof.state=2, jkpof.item.order=1}] run loot give @s loot jkpof:item/prop/death_note/en
execute if score #is_prop jkpof.int matches 1 as @a[scores={jkpof.state=2, jkpof.item.order=2}] run loot give @s loot jkpof:item/prop/creative
execute if score #is_prop jkpof.int matches 1 as @a[scores={jkpof.state=2, jkpof.item.order=3..21}] run loot give @s loot jkpof:item/prop/common

# 非道具
execute unless score #is_prop jkpof.int matches 1 as @a[scores={jkpof.state=2}] run loot give @s loot jkpof:item/main
