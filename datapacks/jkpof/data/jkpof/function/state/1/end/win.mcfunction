...
tag @a[limit=1, scores={jkpof.state=2}, gamemode=survival] add jkpof_winner

execute if score #ctrl_team jkpof.int matches 1..2 run scoreboard players operation #win jkpof.team = @a[limit=1, tag=jkpof_winner] jkpof.team
