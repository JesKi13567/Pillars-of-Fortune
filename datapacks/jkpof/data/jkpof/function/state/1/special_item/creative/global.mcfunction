...
execute as @s[scores={jkpof.creative=60}] run tellraw @a ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF", color: "yellow"}, {translate: "commands.gamemode.success.other", with: [{selector: "@s"}, {translate: "gameMode.creative", color: "gold"}]}, {storage: "jk:pof", interpret: true, nbt: "txt.char.dot"}]
