...
$tellraw @a ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF", color: "yellow"}, {selector: "@a[limit=1, name='$(id)']"}, {storage: "jk:pof", interpret: true, nbt: "txt.lobby.item.player_head.tellraw.success", color: "green"}]
