...
title @s actionbar ["", {storage: "jk:pof", interpret: true, nbt: "txt.lobby.item.global.press", color: "green"}, " [", {keybind: "key.sneak"}, "] ", {storage: "jk:pof", interpret: true, nbt: "txt.lobby.item.void_charm.p1", color: "green"}, {score: {name: "#last_temp", objective: "jkpof.int"}, color: "gold"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.global.seconds", color: "green"}]
