...
execute if score #spectral_hand.fail jkpof.int matches 1 run tellraw @s ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.lobby.item.spectral_hand.tellraw.fail.p0", color: "green"}]
...
execute if score #spectral_hand.fail jkpof.int matches 0 if score #spectral_hand.slot jkpof.int matches ..-1 run tellraw @s ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.lobby.item.spectral_hand.tellraw.fail.p1", color: "green"}, {selector: "@a[limit=1, tag=jkpof_spectral_hand]"}, {storage: "jk:pof", interpret: true, nbt: "txt.lobby.item.spectral_hand.tellraw.fail.p2", color: "green"}]
