...
execute if score #entity_variant jkpof.int matches -1 if score #event_kid_mode jkpof.int matches 1 as @e[type=mannequin, tag=!jkpof_variant_ed] run function jkpof:state/1/progress/event/14_kid_mode/random/0
