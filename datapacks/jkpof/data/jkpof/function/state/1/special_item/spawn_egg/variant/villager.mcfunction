...
execute if score #entity_variant jkpof.int matches -1 if score #event_kid_mode jkpof.int matches 1 as @e[type=mannequin, tag=!jkpof_variant_ed] run attribute @s scale base set 0.5
