...
execute if score #spectral_hand.slot jkpof.int matches ..-1 run return 0

function jkpof:state/1/special_item/spectral_hand/1 with storage jk:pof data.spectral_hand
