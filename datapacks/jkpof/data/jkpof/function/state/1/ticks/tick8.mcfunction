...
# 检查人数
execute unless score #test_mode jkpof.int matches 1 unless score #event_betrayal_hour.status jkpof.int matches 1 run function jkpof:state/1/end/by_teams
