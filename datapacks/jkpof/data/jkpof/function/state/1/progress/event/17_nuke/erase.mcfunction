execute if score #event_nuke.q jkpof.int matches 1 positioned 1 -64 1 run function jkpof:state/1/progress/event/17_nuke/real
execute if score #event_nuke.q jkpof.int matches 2 positioned 1 -64 -24 run function jkpof:state/1/progress/event/17_nuke/real
