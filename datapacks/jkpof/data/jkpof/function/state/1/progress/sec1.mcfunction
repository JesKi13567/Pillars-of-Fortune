...
execute if score #event_mode jkpof.int matches 6 run bossbar set jkpof:progress name [{storage: "jk:pof", nbt: "txt.event.global.next", color: "gold"}, {storage: "jk:pof", nbt: "txt.event.chain_swap.name", color: "aqua"}, " ", {score: {name: "#event_progress", objective: "jkpof.int"}, color: "yellow"}, {storage: "jk:pof", nbt: "txt.seconds"}]
