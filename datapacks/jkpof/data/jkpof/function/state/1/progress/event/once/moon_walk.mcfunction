...
tellraw @a [{text: "【幸运之柱】", color: "yellow"}, {text: "现在给予所有玩家持续", color: "aqua"}, " 15 秒 ", {text: "的", color: "aqua"}, {translate: "effect.minecraft.jump_boost"}, " + ", {translate: "effect.minecraft.slow_falling"}, {text: "。", color: "aqua"}]
