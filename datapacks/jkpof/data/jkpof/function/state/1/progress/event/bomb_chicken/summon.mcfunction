...
execute if score #ctrl_upside_down jkpof.int matches 0 at @p[tag=jkpof_chicken_0] run summon chicken ~ 120 ~ {Tags: ["jkpof", "jkpof_chicken"], Invulnerable: true, NoGravity: true}
execute if score #ctrl_upside_down jkpof.int matches 1 at @p[tag=jkpof_chicken_0] run summon chicken ~ -70 ~ {Tags: ["jkpof", "jkpof_chicken"], Invulnerable: true, NoGravity: true}
