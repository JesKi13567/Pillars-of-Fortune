execute if score #event_mix_16 jkpof.int matches 1 store result score #event_plus_16 jkpof.int run random value 0..1
execute if score #event_plus_16 jkpof.int matches 0 run tellraw @a [{storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.purge.tellraw", color: "aqua"}]
...
execute if score #event_plus_16 jkpof.int matches 1 if score #entity_count jkpof.int matches 300.. run return run tellraw @a [{storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.plus.purge.name", color: "aqua"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.plus.purge.fail", color: "red"}]
execute if score #event_plus_16 jkpof.int matches 1 run tellraw @a [{storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.plus.purge.tellraw", color: "aqua"}]
