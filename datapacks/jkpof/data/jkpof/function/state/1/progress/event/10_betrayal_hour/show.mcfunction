...
execute if score #event_plus_10 jkpof.int matches 1 run tellraw @a ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.plus.betrayal_hour.tellraw", color: "aqua"}, "\n", {storage: "jk:pof", interpret: true, nbt: "txt.POF", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.global.next_reset.tellraw", color: "aqua"}]
execute if score #event_plus_10 jkpof.int matches 1 run tellraw @a[scores={jkpof.betrayal=1}] [{storage: "jk:pof", interpret: true, nbt: "txt.POF", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.plus.betrayal_hour.self", color: "gold"}]
execute if score #event_plus_10 jkpof.int matches 1 run tellraw @a[gamemode=spectator] ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.plus.betrayal_hour.spec", color: "aqua"}, {selector: "@p[scores={jkpof.betrayal=1}]"}]
