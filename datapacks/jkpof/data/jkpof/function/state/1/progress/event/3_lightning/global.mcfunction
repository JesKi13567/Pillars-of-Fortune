...
tellraw @a[tag=!jkpof_lightning_player] ["", {storage: "jk:pof", interpret: true, nbt: "txt.POF", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.lightning.player.others.p1", color: "aqua"}, " ", {selector: "@a[tag=jkpof_lightning_player]"}, " ", {storage: "jk:pof", interpret: true, nbt: "txt.event.lightning.player.others.p2", color: "aqua"}]
