execute if score #event_mix_11 jkpof.int matches 1 store result score #event_plus_11 jkpof.int run random value 0..1
...
execute if score #event_plus_11 jkpof.int matches 0 run tellraw @a [{storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.bountiful_harvest.tellraw", color: "aqua"}]
...
execute if score #event_plus_11 jkpof.int matches 0 as @a[scores={jkpof.state=2}, tag=jkpof_bountiful_harvest] store result score @s jkpof.item.order run random value 1..23
...
execute if score #event_plus_11 jkpof.int matches 1 run tellraw @a [{storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.plus.bountiful_harvest.tellraw", color: "aqua"}]
