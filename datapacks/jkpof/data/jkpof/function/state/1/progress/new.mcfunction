...
execute if score #test_mode jkpof.int matches 1 run scoreboard players remove #progress_count jkpof.int 1
...
execute if score #progress_mode jkpof.int matches 2 run title @a title {text: "地板是岩浆", color: "aqua"}
...
execute if score #progress_mode jkpof.int matches 3 run title @a title {text: "雷劫", color: "aqua"}
