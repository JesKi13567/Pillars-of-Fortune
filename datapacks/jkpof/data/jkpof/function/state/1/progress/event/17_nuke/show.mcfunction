execute if score #event_mix_17 jkpof.int matches 1 store result score #event_plus_17 jkpof.int run random value 0..1
execute if score #event_plus_17 jkpof.int matches 0 run tellraw @a [{storage: "jk:pof", interpret: true, nbt: "txt.POF.show", color: "yellow"}, {text: "5", color: "white"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.global.seconds", color: "white"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.global.later", color: "aqua"}, {storage: "jk:pof", interpret: true, nbt: "txt.event.nuke.tellraw", color: "aqua"}]
