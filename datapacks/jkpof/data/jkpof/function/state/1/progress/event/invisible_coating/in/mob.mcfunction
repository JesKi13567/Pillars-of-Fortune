execute if items entity @s weapon.mainhand * run function jkpof:state/1/progress/event/invisible_coating/in/slot {slot: 'weapon.mainhand'}
...
execute if items entity @s armor.legs * run function jkpof:state/1/progress/event/invisible_coating/in/slot {slot: 'armor.legs'}
execute if items entity @s armor.feet * run function jkpof:state/1/progress/event/invisible_coating/in/slot {slot: 'armor.feet'}
