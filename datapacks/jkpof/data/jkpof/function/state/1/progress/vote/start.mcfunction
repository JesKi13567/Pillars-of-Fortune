...
{selector: "@e[type=marker, tag=jkpof_vote_show, tag=-1]", hover_event: {action: "show_text", value: ["[", {storage: "jk:pof", nbt: "txt.event.border.name"}, "]"]}, click_event: {action: "run_command", command: "/trigger jkpof.vote set 6"}}, \
