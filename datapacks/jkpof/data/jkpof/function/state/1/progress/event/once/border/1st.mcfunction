tellraw @a [{storage: "jk:pof", nbt: "txt.POF", color: "yellow"}, {storage: "jk:pof", nbt: "txt.event.border.tellraw", color: "aqua"}, {text: " →10←", color: "green"}, " 10", {storage: "jk:pof", nbt: "txt.seconds"}, {text: ", ", color: "aqua"}, {text: "↓40↓", color: "green"}, " 20", {storage: "jk:pof", nbt: "txt.seconds"}, {storage: "jk:pof", nbt: "txt.char.exclamation", color: "aqua"}]
