...
execute if score #event_type jkpof.int matches 4 run function jkpof:state/1/progress/event/4_moon_walk/global
execute if score #event_type jkpof.int matches 5 run function jkpof:state/1/progress/event/5_bomb_chicken/global
execute if score #event_type jkpof.int matches 6 if score #event_time jkpof.int matches 40 run function jkpof:state/1/progress/event/6_chain_swap/global
...
execute if score #event_type jkpof.int matches 8 run function jkpof:state/1/progress/event/8_vertical_lock/global
execute if score #event_type jkpof.int matches 9 run function jkpof:state/1/progress/event/9_invisible_coating/global
execute if score #event_type jkpof.int matches 12 run function jkpof:state/1/progress/event/12_iron_torrent/global
...
execute if score #event_type jkpof.int matches 17 run function jkpof:state/1/progress/event/17_nuke/global
