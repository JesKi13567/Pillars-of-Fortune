...
execute if score #ctrl_team jkpof.int matches 1 run scoreboard players set @a jkpof.team 1
execute if score #ctrl_team jkpof.int matches 1 run team join jkpof.red @a
