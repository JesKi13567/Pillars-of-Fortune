...
clear @a
item replace entity @a weapon.offhand with crossbow[enchantments={multishot: 1, quick_charge: 5}]

execute as @a run loot give @s loot jkpof:item/prop/creative
execute unless score #ctrl_lang jkpof.int matches 2 as @a run loot give @s loot jkpof:item/prop/death_note/zh
